...
- **OpenNTPD** — minimalis dan aman, cocok untuk kebutuhan umum → [openntpd.org](https://www.openntpd.org/)
- **Chrony** — sinkronisasi lebih cepat, cocok untuk laptop atau koneksi tidak stabil → [chrony-project.org](https://chrony-project.org/)
