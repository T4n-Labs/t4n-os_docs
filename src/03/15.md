...
* **[Void-Packages · srcpkgs/](https://github.com/void-linux/void-packages)**
* **[VUR - Void User Repository](https://github.com/T4n-Labs/vur) atau [VUR-Web](https://github.com/T4n-Labs/vur-web)**

## Arsitektur Non-x86_64

Beberapa paket tidak mendukung cross-compilation (contoh: pandoc) dan harus dibangun secara lokal di komputer dengan arsitektur dan libc yang sama dengan sistem target. Lihat README repositori [void-packages](https://github.com/void-linux/void-packages/blob/master/README.md) untuk panduan build paket.

## Flatpak

Flatpak adalah metode lain untuk menginstal aplikasi berpemilik eksternal pada Linux. Untuk informasi tentang penggunaan Flatpak dengan T4n OS (Based on Void Linux), lihat situs resminya. [Dokumentasi Flatpak](https://flatpak.org/setup/Void%20Linux) .

### Troubleshooting Flatpak

**Audio tidak berfungsi:**
Pastikan PulseAudio sudah berjalan sebelum meluncurkan aplikasi Flatpak. [Auto-aktivasi PulseAudio](#) mungkin tidak bekerja dengan benar. Pastikan PulseAudio berjalan sebelum meluncurkan program. 
...
Lalu konfigurasi [XDG Desktop Portals](../03/05GraphicalSession/SESSIONS/04.md).

Beberapa Flatpak juga membutuhkan **[D-Bus](https://t4n-labs.github.io/t4n-os_docs/03/12.html#d-bus)** dan/atau **[PulseAudio](../03/07Multimedia/04.md)** untuk berjalan.
