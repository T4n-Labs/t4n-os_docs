...
* **Pengembangan Let-X:** VUR-Helper yang digunakan sebagai tools untuk mempermudah package di T4n OS maupun Void Linux dengan template dari [VUR(T4n-Labs)](https://t4n-labs.github.io/vur/) atau template dari [Void Linux](https://github.com/void-linux/void-packages)
