...
Setelah kamu mengunduh file ISO [T4n OS](../01.md#file-iso), langkah berikutnya adalah membuat media instalasi yang bisa digunakan untuk boot (USB, SD Card, atau DVD).
...
Via `dd`, gunakan perintah berikut:
