...
Dukungan T4n OS untuk Apple Silicon berbasis **Asahi Linux**.
Lihat [website](https://asahilinux.org) dan [dokumentasi](https://asahilinux.org/docs) Asahi Linux untuk informasi lebih lanjut.
